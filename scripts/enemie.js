...
var Enemy = function(game)
{
  ...
  resizePolygon("physicsDataEnemies","physicsDataEnemiesScaled",this.view,this.scaleE);
  this.body.clearShapes();
  this.body.loadPolygon("physicsDataEnemiesScaled",this.view);
  this.speed = 3500/(this.height/2);
  this.reset(1000,Math.random() * 600-this.height*2 + this.height*2);
  this.lifetime = 0;
};

Enemy.prototype = Object.create(Phaser.Sprite.prototype);
Enemy.prototype.constructior = Enemy;
